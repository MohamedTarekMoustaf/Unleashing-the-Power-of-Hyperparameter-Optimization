...
knowledge to guide the manual search process. These techniques aim to enhance the visual classification accuracy of convolutional deep neural networks, specifically PointNet. The hyperparameters targeted for tuning are the mini-batch size of stochastic gradient descent (SGD), momentum, and learning rate. The objective is
